...
ssh-keygen -t rsa -b 2048 -P '' -f /home/vagrant/.ssh/clouderakey
cd /home/vagrant/.ssh/
cat clouderakey.pub >> authorized_keys
chmod 0600 authorized_keys
openssl rsa -in clouderakey -outform pem > /home/vagrant/.ssh/clouderakey.pem
chmod 0400 /home/vagrant/.ssh/clouderakey.pem
cp /home/vagrant/.ssh/clouderakey.pem /home/cloudera
cp /home/vagrant/.ssh/clouderakey.pem /home/vagrant
...
echo "`ip a |grep '192.168'| awk '{print($2)}' | sed 's/...$//'` `hostname` `domainname -a | awk '{print($1 " " $1)}'`" >> /etc/hosts
...
mkdir /opt/clo/etc/sysconfig/networkdera/parcel-cache
